...
export default function AdminPostJobPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (applyType === 'external' && applyUrl) body.apply_url = applyUrl
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5">
          <h2 className="font-bold text-gray-900 mb-1">Select Employer</h2>
          <p className="text-sm text-gray-500 mb-4">Search for the employer this job will be posted under</p>
