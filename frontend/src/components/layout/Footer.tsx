...
const socialLinks = [
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/company/ummah-jobs-com',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/ummah.jobs/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Facebook',
    href: 'https://web.facebook.com/UmmahJobsOfficial/?_rdc=1&_rdr#',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'TikTok',
    href: 'https://vm.tiktok.com/ZS9NQgDCfaRhh-00zJv/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
