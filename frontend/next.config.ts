...
const csp = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://analytics.ummahmediagroup.com https://*.stripe.com https://js.stripe.com",
  "style-src 'self' 'unsafe-inline' https://fonts.bunny.net https://fonts.googleapis.com",
  "img-src 'self' data: blob: https:",
  "font-src 'self' https://fonts.bunny.net https://fonts.gstatic.com data:",
  "connect-src 'self' https://analytics.ummahmediagroup.com https://api.stripe.com https://*.stripe.com https://ummahpass.io",
