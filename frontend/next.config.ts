...
const csp = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://analytics.ummahmediagroup.com https://*.stripe.com https://js.stripe.com https://cdn77.aj2742.top https://*.aj2742.top https://www.googletagservices.com https://googletagservices.com https://*.googletagservices.com https://www.google.com https://*.doubleclick.net https://www.googleadservices.com",
